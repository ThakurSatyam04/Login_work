    ...
    <>
        <div className='flex flex-col '>
            ...
            <div className='w-screen h-[573px] flex'>
                ...
                <div className=' group w-full dark:text-gray-300 border-black/10 dark:border-gray-900/50 dark:bg-[#444654]'>
                        ...
                        <div className='bg-gray-800 backdrop-filter backdrop-blur-4xl backdrop-top rounded-md h-[100px] fixed bottom-[0px] w-3/4 flex items-center justify-center '>
                            <input type="text" className='w-3/4 bg-gray-300 border rounded-md border-red-900 h-[50px] p-3 text-richblack-800' value={search} placeholder='Type here to search' onChange={handleOnChange}/>
                    ...
                    <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24"        strokeLinecap="round" strokeLinejoin="round" class="h-4 w-4 m-1" height="1em"        width="1em" xmlns="http://www.w3.org/2000/svg">
